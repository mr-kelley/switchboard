...
## Project Overview
Switchboard is a Slack-style multi-session terminal manager built for developers who run AI coding agents in parallel. Electron desktop app with React UI, xterm.js terminals, and node-pty backend. Repository: `gits/switchboard`. Current phase: **Flow (v2) — complete**.

## Active Work
- **Milestone:** Flow (v2) — complete.
- No active sprint. All 5 Flow sprints delivered.
...
## Session Notes
Flow (v2) milestone complete. All 5 sprints delivered and promoted to main. 176 tests passing across 21 test files. Ready for user testing or to begin Intelligence (v3) milestone.
